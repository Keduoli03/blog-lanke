    ...
    articleItem += `
      <div class="card" onclick="window.open('${link}', '_blank')">
        ...
        <div class="card-author" title="访问 ${author} 的站点" onclick="event.stopPropagation(); window.open('${authorLink}', '_blank')">
          <img class="no-lightbox" data-no-lightbox src="${avatar}" alt="${author}" onerror="this.src='${error_img}'">
          <span>${author}</span>
        </div>
        <div class="card-date">
        ...
        <img class="card-bg no-lightbox" data-no-lightbox src="${avatar}" alt="" onerror="this.src='${error_img}'">
      </div>
    `
  }
